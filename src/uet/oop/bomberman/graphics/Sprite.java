...
public class Sprite {
    ...
    public static final int SCALED_SIZE = DEFAULT_SIZE * 2;//Game.SCALE;
    ...
    public static Sprite movingSprite(Sprite x0, Sprite x1, Sprite x2, Sprite x3,int animate, int time) {
